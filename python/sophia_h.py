class Sophia:
  ...
  IDs = { ("lhy", 0x30,        0x31,        0x3c,   0x30,   ENABLE_LEFT ,   1.0,            -1.0,                  0,  -19.4     ),
          ...
          ("lay", 0x38,        0x38,        0x38,   0x38,   True        ,   1.0,            -1.0,                  4,    0.0     ),
          ("lar", 0x39,        0x39,        0x39,   0x39,   True        ,   1.0,            -1.0,                  5,    0.0     ),
          ("lap", 0x3a,        0x3a,        0x3a,   0x3a,   True        ,   0.4,            -1.0,                  6,    0.0     ),
          ("ltp", 0x3b,        0x3b,        0x3b,   0x3b,   True        ,   1.0,            -1.0,                  7,    0.0     ),
          ...
          ("ray", 0x18,        0x18,        0x18,   0x18,   True        ,   1.0,            -1.0,                 12,    0.0     ),
          ("rar", 0x19,        0x19,        0x19,   0x19,   True        ,   1.0,            -1.0,                 13,    0.0     ),
          ("rap", 0x1a,        0x1a,        0x1a,   0x1a,   True        ,   0.4,            -1.0,                 14,    0.0     ),
          ("rtp", 0x1b,        0x1b,        0x1b,   0x1b,   True        ,   1.0,            -1.0,                 15,    0.0     )
        }
