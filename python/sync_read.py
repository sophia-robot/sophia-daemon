...
if MY_DXL == 'X_SERIES' or MY_DXL == 'MX_SERIES':
    ...
    DXL_MINIMUM_POSITION_VALUE  = 1900      # Refer to the Minimum Position Limit of product eManual
    DXL_MAXIMUM_POSITION_VALUE  = 2100      # Refer to the Maximum Position Limit of product eManual
    BAUDRATE                    = 1000000
...
DXL1_ID                     = 0x14                 # Dynamixel#1 ID : 1
DXL2_ID                     = 0x15                 # Dynamixel#1 ID : 2
